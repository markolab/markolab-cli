import click
from io import convert_raw_to_avi
...
def convert_raw_to_avi_cli(input_filename, output_filename, chunk_size, fps, delete, threads, codec):
    convert_raw_to_avi(input_filename, output_filename, chunk_size, fps, delete, threads, codec)